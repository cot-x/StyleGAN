...
class Solver:
    ...
    def trainGAN(self, epoch, iters, max_iters, real_img, a=0, b=1, c=1):
        ...
        fake_src_score, fake_small_score = self.netD((fake_img_aug, fake_img_small))
        ...
        # Backward and optimize.
        g_loss = 0.5 * (fake_src_loss + fake_small_loss) / self.args.batch_size + self.args.lambda_path * path_penalty
